...
public class BrembopartsUiTest extends BaseTest {
    ...
    public void testLoginFormWithIncorrectData() {
        StepLoginForm.openHomePageAndClickButtonAccountAndSendKeysUserNameAndSendKeysPasswordAndClickButtonLogIn();
    ...
    public void testLoginFormWithLoginIsEmptyAndRandomPassword() {
        StepLoginForm.openHomePageAndClickButtonAccountAndSendKeysPasswordAndClickButtonLogIn();
    ...
    public void testLoginFormWithLoginIsRandomPasswordIsEmpty() {
        StepLoginForm.openHomePageAndClickButtonAccountAndSendKeysUserNameAndClickButtonLogIn();
    ...
    public void testLoginFormWithLoginAndPasswordIsEmpty() {
        StepLoginForm.openHomePageAndClickButtonAccountAndClickButtonLogIn();
